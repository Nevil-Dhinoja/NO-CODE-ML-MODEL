...
# # This is a simple Streamlit app that allows usere data for machine learning model training.
# # app.py s to upload a CSV file,
...
#         st.switch_page("pages/4_model_trainer.py")
...
st.title("🧠 No-Code Machine Learning Builder")
st.markdown("""
Welcome to the **No-Code ML Builder** 👋
...
- 📊 Explore insights
- 🧠 Train ML models
- 📈 Make predictions — all **without writing a single line of code**!

---

🚀 **Get started by selecting a page from the sidebar** — begin with **Preprocessing** to upload and clean your data, The Train your Model as best as you want.
""")
